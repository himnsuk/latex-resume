...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\Large\underline {\uppercase{Himanshu Kesarvani}}} & Email : \href{mailto:himanshukesarvanii@gmail.com}{himanshukesarvanii@gmail.com}\\
  \textbf {{BI-Data Scientist}} & Mobile : +91-7702489286 \\
\end{tabular*}

%--------Professional Summary------------
\section*{Professional Summary}
Experienced data scientist with a strong focus on user behavior, experience, and engagement. 
Proficient in data science and statistics, Natural Language Processing(NLP) with over 11 years 
of overall experience, including 8 years specifically in data science. 
Skilled in leveraging data insights to propel business growth.

%--------SKILLS------------
\section{Skills}
\resumeSubHeadingListStart
\item \textbf{Skills}{: Statistical Analysis, Machine Learning, Deep Learning, Data Visualization, NLP, Data Mining, Data Wrangling}
\item \textbf{ML Algorithms}{: Applied a range of machine learning algorithms, including Linear Regression, Logistic Regression, Decision Tree, Ensemble Learning algorithms, K-means, and K-nearest neighbors (KNN), RoBERTa.}
\item \textbf{Languages}{: Python, R, SQL, Spark, Qlik Sense, Power BI, MS Excel, Tableau, PyTorch}
\item \textbf{Cloud}{: Google Cloud, Microsoft Azure}
...
Developed an ML model to predict 'fitment \%' for job applications, ensuring a bias-free and equitable recruitment process by identifying influential factors. Presented actionable insights to business leaders to promote equal opportunity and optimize talent acquisition.
\resumeItemListEnd
