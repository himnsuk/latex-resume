    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Doc-Bot}
          ...
          \begin{itemize}
              \item[--] Developed a NLP model using BERT to answer the question regarding documentation queries
        ...
        \resumeItem{Social Network}
          ...
          \begin{itemize}
              \item[--] Developed Topic Modeling using LDA algorithm for social media messages for enterprises
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Hiring Biases}
          {Built a classifier model to find biases in the hirigin process}
          \begin{itemize}
              \item[--] Created a model using XGBoost alogrith to predict biases introduced by interviewer
              \item[--] Create another model using Random Forest Regressor algorithm to find the fitment percentage of candiate
